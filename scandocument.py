...
my_button = customtkinter.CTkButton(master=root, text="Generate Qr Code", command=create_code)
my_button.pack( pady=20)

my_button2 = customtkinter.CTkButton(master=root, text="Clear",text_color="red",fg_color="yellow", command=clear_all)
my_button2.pack()
